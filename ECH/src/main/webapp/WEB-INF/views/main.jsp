        ...
        <div class="wrap">
            <div class="menu">
                <div class="menu-list1">
                    <div class="menu-img">
                        <a href="#"><img src="resources/main/images/dashboard.png"></a>
                    </div>
                ...
                <div class="menu-list3">
                    <div class="menu-img">
                        <a href="#"><img src="resources/main//images/still-cut.png"></a>
                    </div>
                    <div class="menu-title">
                        <a href="#">Still-cut</a>
                    </div>
                ...
                <div class="menu-list4">
                    <div class="menu-img">
                        <a href="#"><img src="resources/main//images/cctv.png"></a>
                    </div>
                    <div class="menu-title">
                        <a href="#">CCTV</a>
                    </div>
                ...
                <div class="menu-list5">
                    <div class="menu-img">
                        <a href="#"><img src="resources/main//images/people.png"></a>
                    </div>
                    <div class="menu-title">
                        <a href="#">Number of People</a>
                    </div>
                </div>
                <div class="menu-list6">
                    <a href="#"><img src="resources/main//images/settings.png"></a>
                    <div class="menu-title">
                        <a href="#">Settings</a>
                    </div>
                </div>
