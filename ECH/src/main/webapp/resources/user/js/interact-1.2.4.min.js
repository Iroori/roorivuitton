/* interact.js v1.2.4 | https://raw.github.com/taye/interact.js/master/LICENSE */ ! function(t) {
    "use strict";
    ...
    De.indexOfElement = function(t, e) {
            ...
            fire: function(t) {
                ...
                if (t.type in this._iEvents)
                    for (e = this._iEvents[t.type], i = 0, r = e.length; r > i && !t.immediatePropagationStopped; i++) n = e[i].name, e[i](t);
                if (a(this[s]) && (n = this[s].name, this[s](t)), t.type in Ne && (e = Ne[t.type]))
                    for (i = 0, r = e.length; r > i && !t.immediatePropagationStopped; i++) n = e[i].name, e[i](t);
                return this
            },
            on: function(t, e, i) {
                var r;
                ...
                if ("wheel" === t && (t = Fe), i = i ? !0 : !1, he(qe, t)) t in this._iEvents ? this._iEvents[t].push(e) : this._iEvents[t] = [e];
            ...
            off: function(t, e, i) {
                ...
                var a, h = -1;
                if (i = i ? !0 : !1, "wheel" === t && (t = Fe), he(qe, t)) a = this._iEvents[t], a && -1 !== (h = ae(a, e)) && this._iEvents[t].splice(h, 1);
                else if (this.selector) {
                    var p = Ce[t],
                        c = !1;
                    if (!p) return this;
